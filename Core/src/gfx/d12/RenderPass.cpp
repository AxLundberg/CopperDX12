...
namespace CPR::GFX::D12
{
	...
	void RenderPass::SetGlobalSampler(PipelineShaderStage shader, u8 slot, ResourceIndex index)
	{
		switch (shader)
		{
	...
	ResourceIndex RenderPass::GetGlobalSampler(PipelineShaderStage shader, u8 slot) const
	{
		switch (shader)
		{
		case PipelineShaderStage::VS:
